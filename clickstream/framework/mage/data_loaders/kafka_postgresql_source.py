# ==============================================================================
# Kafka Streaming Source - PostgreSQL Consumer Pipeline
# ==============================================================================
"""
Kafka streaming source for the PostgreSQL consumer pipeline.
...
Configuration via environment variables:
    ...
    POSTGRESQL_CONSUMER_GROUP_ID: Consumer group ID
"""
...
@streaming_source
class KafkaSourcePostgresql(BasePythonSource):
    """Kafka source for clickstream events (PostgreSQL pipeline)."""

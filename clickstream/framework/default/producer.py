# ==============================================================================
# Default Framework Producer (kafka-python)
# ==============================================================================
"""
Default producer implementation using kafka-python.

This is the baseline producer implementation with no external streaming
framework dependencies. Uses kafka-python directly for publishing events
to Kafka.

Performance optimization: Uses Polars for fast CSV loading instead of
row-by-row CSV reader with Pydantic validation.

Other frameworks (like Mage) can delegate to this producer when they
